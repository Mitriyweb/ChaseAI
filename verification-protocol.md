...
1. **Proactive Hand-off**: When you plan a restricted operation, call `POST http://127.0.0.1:8888/verify` immediately.
...
- `GET http://127.0.0.1:8888/health`: Check if the bridge is alive.
- `POST http://127.0.0.1:8888/verify`: Request approval for an action.
- `GET http://127.0.0.1:8888/context`: Retrieve capability constraints.
